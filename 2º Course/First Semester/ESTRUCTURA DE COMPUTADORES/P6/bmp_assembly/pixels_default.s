	/*
Programa:	 pixels_default.s
Compilación:	as --32 -gstabs -o pixels.o pixels_default.s
...
Metodogía:	 Desarrollar el algoritmo en lenguaje C
	...
	Después generamos reservamos la primera dimensión con un array de direcciones de memoria sin inicializar:
...
columna:	
	...
	## Inicializar colores en el pixel
	...
	inc %esi
	cmp fin_y,%esi
	jnz columna		#siguiente columna
	## actualización posición fila
col_exit:
	inc %edi
	cmp fin_x,%edi
	jnz fila		#siguiente fila
fil_exit:	
