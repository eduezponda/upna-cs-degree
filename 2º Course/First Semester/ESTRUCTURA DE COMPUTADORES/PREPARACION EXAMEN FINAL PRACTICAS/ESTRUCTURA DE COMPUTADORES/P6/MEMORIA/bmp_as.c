...
void pixels_generator(unsigned int lado, unsigned int dimension, RGB_data reg_mem[][DIMENSION]);
...
int main(int argc, char **argv)
{
    ...
    pixels_generator(LADO,DIMENSION,buffer); //proporcion=intensidad del gris
