        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(file))) {
            ...
            while ((line = reader.readLine()) != null) {
                try{
                    ...
                    //if (parts.length == 20) {
                    if ((parts[0].equals("") == false) && (parts[1].equals("") == false) && (parts[2].equals("") == false) && (parts[3].equals("") == false) && (parts[8].equals("") == false)){
                        String name = parts[0].trim(); //trim = quit spaces before and after
